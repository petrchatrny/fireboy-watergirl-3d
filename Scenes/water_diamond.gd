...
@export var type: String = "water"  # This type identifies the diamond as a "water" diamond
...
func _on_body_entered(body: Node) -> void:
	...
	if body is CharacterBody3D:
		...
		if body.is_watergirl and type == "water":  # If the player is Watergirl and the diamond is a water diamond
			...
			body.add_score(1)  # Add score to the Watergirl
